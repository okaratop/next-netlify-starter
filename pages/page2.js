  ...
  return (
    <div className="container">
      ...
      <main>
        ...
        <a href="https://lively-gnome-333ad2.netlify.app/"><button style="background: #069cc2; border-radius: 6px; padding: 15px; cursor: pointer; color: #fff; border: none; font-size: 16px;">Voltar</button></a>
      </main>
